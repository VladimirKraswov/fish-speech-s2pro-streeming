...
FISH_STREAM_MAX_AHEAD_CHUNKS="${FISH_STREAM_MAX_AHEAD_CHUNKS:-3}"
...
FISH_STREAM_CHUNK_SIZE="${FISH_STREAM_CHUNK_SIZE:-8}"
FISH_INITIAL_STREAM_CHUNK_SIZE="${FISH_INITIAL_STREAM_CHUNK_SIZE:-8}"
