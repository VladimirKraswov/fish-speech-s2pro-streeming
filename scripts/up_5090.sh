...
FISH_DAC_MIN_FREE_GB="${FISH_DAC_MIN_FREE_GB:-3.0}"
FISH_DAC_RESUME_FREE_GB="${FISH_DAC_RESUME_FREE_GB:-5.0}"
FISH_DAC_CRITICAL_FREE_GB="${FISH_DAC_CRITICAL_FREE_GB:-1.5}"
...
FISH_LLM_CRITICAL_FREE_GB="${FISH_LLM_CRITICAL_FREE_GB:-1.5}"
